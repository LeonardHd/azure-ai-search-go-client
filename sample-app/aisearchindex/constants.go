...
const (
// QueryDebugModeDisabled - No query debugging information will be returned.
	QueryDebugModeDisabled QueryDebugMode = "disabled"
// QueryDebugModeVector - Allows the user to further explore their hybrid and vector query results.
	QueryDebugModeVector QueryDebugMode = "vector"
)

// PossibleQueryDebugModeValues returns the possible values for the QueryDebugMode const type.
func PossibleQueryDebugModeValues() []QueryDebugMode {
	return []QueryDebugMode{	
		QueryDebugModeDisabled,
		QueryDebugModeVector,
	}
}
