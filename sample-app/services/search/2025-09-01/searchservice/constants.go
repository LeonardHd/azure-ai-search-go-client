...
// DocumentIntelligenceLayoutSkillChunkingUnit - Controls the cardinality of the chunk unit. Default is 'characters'
type DocumentIntelligenceLayoutSkillChunkingUnit string

const (
// DocumentIntelligenceLayoutSkillChunkingUnitCharacters - Specifies chunk by characters.
	DocumentIntelligenceLayoutSkillChunkingUnitCharacters DocumentIntelligenceLayoutSkillChunkingUnit = "characters"
)

// PossibleDocumentIntelligenceLayoutSkillChunkingUnitValues returns the possible values for the DocumentIntelligenceLayoutSkillChunkingUnit const type.
func PossibleDocumentIntelligenceLayoutSkillChunkingUnitValues() []DocumentIntelligenceLayoutSkillChunkingUnit {
	return []DocumentIntelligenceLayoutSkillChunkingUnit{	
		DocumentIntelligenceLayoutSkillChunkingUnitCharacters,
	}
}

// DocumentIntelligenceLayoutSkillExtractionOptions - Controls the cardinality of the content extracted from the document
// by the skill.
type DocumentIntelligenceLayoutSkillExtractionOptions string

const (
// DocumentIntelligenceLayoutSkillExtractionOptionsImages - Specify that image content should be extracted from the document.
	DocumentIntelligenceLayoutSkillExtractionOptionsImages DocumentIntelligenceLayoutSkillExtractionOptions = "images"
// DocumentIntelligenceLayoutSkillExtractionOptionsLocationMetadata - Specify that location metadata should be extracted from
// the document.
...
// PossibleDocumentIntelligenceLayoutSkillExtractionOptionsValues returns the possible values for the DocumentIntelligenceLayoutSkillExtractionOptions const type.
func PossibleDocumentIntelligenceLayoutSkillExtractionOptionsValues() []DocumentIntelligenceLayoutSkillExtractionOptions {
	return []DocumentIntelligenceLayoutSkillExtractionOptions{	
		DocumentIntelligenceLayoutSkillExtractionOptionsImages,
		DocumentIntelligenceLayoutSkillExtractionOptionsLocationMetadata,
	}
}

// DocumentIntelligenceLayoutSkillMarkdownHeaderDepth - The depth of headers in the markdown output. Default is h6.
type DocumentIntelligenceLayoutSkillMarkdownHeaderDepth string

const (
// DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH1 - Header level 1.
	DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH1 DocumentIntelligenceLayoutSkillMarkdownHeaderDepth = "h1"
// DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH2 - Header level 2.
	DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH2 DocumentIntelligenceLayoutSkillMarkdownHeaderDepth = "h2"
// DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH3 - Header level 3.
	DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH3 DocumentIntelligenceLayoutSkillMarkdownHeaderDepth = "h3"
// DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH4 - Header level 4.
	DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH4 DocumentIntelligenceLayoutSkillMarkdownHeaderDepth = "h4"
// DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH5 - Header level 5.
	DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH5 DocumentIntelligenceLayoutSkillMarkdownHeaderDepth = "h5"
// DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH6 - Header level 6.
	DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH6 DocumentIntelligenceLayoutSkillMarkdownHeaderDepth = "h6"
)

// PossibleDocumentIntelligenceLayoutSkillMarkdownHeaderDepthValues returns the possible values for the DocumentIntelligenceLayoutSkillMarkdownHeaderDepth const type.
func PossibleDocumentIntelligenceLayoutSkillMarkdownHeaderDepthValues() []DocumentIntelligenceLayoutSkillMarkdownHeaderDepth {
	return []DocumentIntelligenceLayoutSkillMarkdownHeaderDepth{	
		DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH1,
		DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH2,
		DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH3,
		DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH4,
		DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH5,
		DocumentIntelligenceLayoutSkillMarkdownHeaderDepthH6,
	}
}

// DocumentIntelligenceLayoutSkillOutputFormat - Controls the cardinality of the output format. Default is 'markdown'.
type DocumentIntelligenceLayoutSkillOutputFormat string

const (
// DocumentIntelligenceLayoutSkillOutputFormatMarkdown - Specify the format of the output as markdown.
	DocumentIntelligenceLayoutSkillOutputFormatMarkdown DocumentIntelligenceLayoutSkillOutputFormat = "markdown"
// DocumentIntelligenceLayoutSkillOutputFormatText - Specify the format of the output as text.
	DocumentIntelligenceLayoutSkillOutputFormatText DocumentIntelligenceLayoutSkillOutputFormat = "text"
)

// PossibleDocumentIntelligenceLayoutSkillOutputFormatValues returns the possible values for the DocumentIntelligenceLayoutSkillOutputFormat const type.
func PossibleDocumentIntelligenceLayoutSkillOutputFormatValues() []DocumentIntelligenceLayoutSkillOutputFormat {
	return []DocumentIntelligenceLayoutSkillOutputFormat{	
		DocumentIntelligenceLayoutSkillOutputFormatMarkdown,
		DocumentIntelligenceLayoutSkillOutputFormatText,
	}
}

// DocumentIntelligenceLayoutSkillOutputMode - Controls the cardinality of the output produced by the skill. Default is 'oneToMany'.
type DocumentIntelligenceLayoutSkillOutputMode string

const (
// DocumentIntelligenceLayoutSkillOutputModeOneToMany - Specify that the output should be parsed as 'oneToMany'.
	DocumentIntelligenceLayoutSkillOutputModeOneToMany DocumentIntelligenceLayoutSkillOutputMode = "oneToMany"
)

// PossibleDocumentIntelligenceLayoutSkillOutputModeValues returns the possible values for the DocumentIntelligenceLayoutSkillOutputMode const type.
func PossibleDocumentIntelligenceLayoutSkillOutputModeValues() []DocumentIntelligenceLayoutSkillOutputMode {
	return []DocumentIntelligenceLayoutSkillOutputMode{	
		DocumentIntelligenceLayoutSkillOutputModeOneToMany,
	}
}
...
// LexicalNormalizerName - Defines the names of all text normalizers supported by the search engine.
type LexicalNormalizerName string

const (
// LexicalNormalizerNameASCIIFolding - Converts alphabetic, numeric, and symbolic Unicode characters which are not in the
// first 127 ASCII characters (the "Basic Latin" Unicode block) into their ASCII equivalents, if such equivalents exist. See
// http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/ASCIIFoldingFilter.html
	LexicalNormalizerNameASCIIFolding LexicalNormalizerName = "asciifolding"
// LexicalNormalizerNameElision - Removes elisions. For example, "l'avion" (the plane) will be converted to "avion" (plane).
// See http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/util/ElisionFilter.html
	LexicalNormalizerNameElision LexicalNormalizerName = "elision"
// LexicalNormalizerNameLowercase - Normalizes token text to lowercase. See https://lucene.apache.org/core/6_6_1/analyzers-common/org/apache/lucene/analysis/core/LowerCaseFilter.html
	LexicalNormalizerNameLowercase LexicalNormalizerName = "lowercase"
// LexicalNormalizerNameStandard - Standard normalizer, which consists of lowercase and asciifolding. See http://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/reverse/ReverseStringFilter.html
	LexicalNormalizerNameStandard LexicalNormalizerName = "standard"
// LexicalNormalizerNameUppercase - Normalizes token text to uppercase. See https://lucene.apache.org/core/6_6_1/analyzers-common/org/apache/lucene/analysis/core/UpperCaseFilter.html
	LexicalNormalizerNameUppercase LexicalNormalizerName = "uppercase"
)

// PossibleLexicalNormalizerNameValues returns the possible values for the LexicalNormalizerName const type.
func PossibleLexicalNormalizerNameValues() []LexicalNormalizerName {
	return []LexicalNormalizerName{	
		LexicalNormalizerNameASCIIFolding,
		LexicalNormalizerNameElision,
		LexicalNormalizerNameLowercase,
		LexicalNormalizerNameStandard,
		LexicalNormalizerNameUppercase,
	}
}
...
// RankingOrder - Represents score to use for sort order of documents.
type RankingOrder string

const (
// RankingOrderBoostedRerankerScore - Sets sort order as BoostedRerankerScore
	RankingOrderBoostedRerankerScore RankingOrder = "BoostedRerankerScore"
// RankingOrderReRankerScore - Sets sort order as ReRankerScore
	RankingOrderReRankerScore RankingOrder = "RerankerScore"
)

// PossibleRankingOrderValues returns the possible values for the RankingOrder const type.
func PossibleRankingOrderValues() []RankingOrder {
	return []RankingOrder{	
		RankingOrderBoostedRerankerScore,
		RankingOrderReRankerScore,
	}
}
...
const (
// SearchIndexerDataSourceTypeAdlsGen2 - Definition of an Azure ADLS Gen 2 datasource whose credentials can either be a storage
// connection string or the ResourceId of the storage account. The container property refers to the blob container to be indexed
// and the optional query property refers to a specific sub-folder in the container.
	SearchIndexerDataSourceTypeAdlsGen2 SearchIndexerDataSourceType = "adlsgen2"
// SearchIndexerDataSourceTypeAzureBlob - Definition of an Azure Blob datasource whose credentials can either be a storage
// connection string or the ResourceId of the storage account. The container property refers to the blob container to be indexed
// and the optional query property refers to a specific sub-folder in the container.
	SearchIndexerDataSourceTypeAzureBlob SearchIndexerDataSourceType = "azureblob"
// SearchIndexerDataSourceTypeAzureSQL - Definition of an Azure SQL datasource whose credentials can either be a standard
// SQL connection string or the ResourceId of the SQL resource. The container property refers to the table or view to be indexed.
...
// SearchIndexerDataSourceTypeAzureTable - Definition of an Azure Table datasource whose credentials can either be a table
// connection string or the ResourceId of the storage account. The container property refers to the blob container to be indexed
// and the optional query property can be used to filter rows.
	SearchIndexerDataSourceTypeAzureTable SearchIndexerDataSourceType = "azuretable"
// SearchIndexerDataSourceTypeCosmosDb - Definition of an CosmosDB datasource whose credentials can either be a formatted
// connection string containing details for AccountEndpoint, AccountKey, and Database for a key based connection or details
// for ResourceID and ApiKind for keyless connection. The container property refers to cosmosdb collection to be indexed and
// the optional query property refers to a SQL query on the collection.
	SearchIndexerDataSourceTypeCosmosDb SearchIndexerDataSourceType = "cosmosdb"
// SearchIndexerDataSourceTypeMySQL - Definition of an Azure SQL datasource whose credentials can either be a standard ADO.NET
// formatted SQL connection string or the ResourceId of the SQL resource. The container property refers to the table or view
// to be indexed. Query parameter is not supported for this datasource.
	SearchIndexerDataSourceTypeMySQL SearchIndexerDataSourceType = "mysql"
// SearchIndexerDataSourceTypeOneLake - Definition of an Microsoft Fabric Onelake datasource whose credentials can either
// be the Fabric workspace GUID or a workspace FQDN. The container property refers to the lakehouse GUID and the optional
// query property refers to folders or shortcuts in the lakehouse.
...
func PossibleSearchIndexerDataSourceTypeValues() []SearchIndexerDataSourceType {
	return []SearchIndexerDataSourceType{	
		...
		SearchIndexerDataSourceTypeOneLake,
	}
}
...
// VectorSearchCompressionRescoreStorageMethod - The storage method for the original full-precision vectors used for rescoring
// and internal index operations.
type VectorSearchCompressionRescoreStorageMethod string

const (
// VectorSearchCompressionRescoreStorageMethodDiscardOriginals - This option discards the original full-precision vectors.
// Choose this option for maximum storage savings. Since this option does not allow for rescoring and oversampling, it will
// often cause slight to moderate reductions in quality.
	VectorSearchCompressionRescoreStorageMethodDiscardOriginals VectorSearchCompressionRescoreStorageMethod = "discardOriginals"
// VectorSearchCompressionRescoreStorageMethodPreserveOriginals - This option preserves the original full-precision vectors.
// Choose this option for maximum flexibility and highest quality of compressed search results. This consumes more storage
// but allows for rescoring and oversampling.
...
// PossibleVectorSearchCompressionRescoreStorageMethodValues returns the possible values for the VectorSearchCompressionRescoreStorageMethod const type.
func PossibleVectorSearchCompressionRescoreStorageMethodValues() []VectorSearchCompressionRescoreStorageMethod {
	return []VectorSearchCompressionRescoreStorageMethod{	
		VectorSearchCompressionRescoreStorageMethodDiscardOriginals,
		VectorSearchCompressionRescoreStorageMethodPreserveOriginals,
	}
}
