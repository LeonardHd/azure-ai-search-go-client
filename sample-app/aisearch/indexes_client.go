...
func (client *IndexesClient) Create(ctx context.Context, indexParam SearchIndex, requestOptions *RequestOptions, options *IndexesClientCreateOptions) (IndexesClientCreateResponse, error) {
	var err error
...
func (client *IndexesClient) createCreateRequest(ctx context.Context, indexParam SearchIndex, requestOptions *RequestOptions, _ *IndexesClientCreateOptions) (*policy.Request, error) {
	urlPath := "/indexes"
	req, err := runtime.NewRequest(ctx, http.MethodPost, runtime.JoinPaths(client.endpoint, urlPath))
	if err != nil {
		return nil, err
...
func (client *IndexesClient) createHandleResponse(resp *http.Response) (IndexesClientCreateResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SearchIndex); err != nil {
		return IndexesClientCreateResponse{}, err
	}
	return result, nil
}
...
//   - RequestOptions - RequestOptions contains a group of parameters for the DataSourcesClient.CreateOrUpdate method.
func (client *IndexesClient) CreateOrUpdate(ctx context.Context, indexName string, prefer Enum0, indexParam SearchIndex, options *IndexesClientCreateOrUpdateOptions, requestOptions *RequestOptions) (IndexesClientCreateOrUpdateResponse, error) {
	var err error
...
func (client *IndexesClient) createOrUpdateCreateRequest(ctx context.Context, indexName string, prefer Enum0, indexParam SearchIndex, options *IndexesClientCreateOrUpdateOptions, requestOptions *RequestOptions) (*policy.Request, error) {
