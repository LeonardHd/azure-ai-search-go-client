...
func (a AnalyzeRequest) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "normalizer", a.Normalizer)
...
func (a *AnalyzeRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "charFilters":
			...
			delete(rawMsg, key)
		case "normalizer":
				err = unpopulate(val, "Normalizer", &a.Normalizer)
			delete(rawMsg, key)
		case "text":
...
func (a *AzureOpenAIEmbeddingSkill) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "apiKey":
			...
			delete(rawMsg, key)
		case "authIdentity":
			a.AuthIdentity, err = unmarshalSearchIndexerDataIdentityClassification(val)
			delete(rawMsg, key)
		case "context":
...
func (b BinaryQuantizationCompressionConfiguration) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "rescoringOptions", b.RescoringOptions)
	populate(objectMap, "truncationDimension", b.TruncationDimension)
	return json.Marshal(objectMap)
}
...
func (b *BinaryQuantizationCompressionConfiguration) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "name":
			...
			delete(rawMsg, key)
		case "rescoringOptions":
				err = unpopulate(val, "RescoringOptions", &b.RescoringOptions)
			delete(rawMsg, key)
		case "truncationDimension":
				err = unpopulate(val, "TruncationDimension", &b.TruncationDimension)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
// MarshalJSON implements the json.Marshaller interface for type CustomNormalizer.
func (c CustomNormalizer) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "charFilters", c.CharFilters)
	populate(objectMap, "name", c.Name)
	objectMap["@odata.type"] = "#Microsoft.Azure.Search.CustomNormalizer"
	populate(objectMap, "tokenFilters", c.TokenFilters)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CustomNormalizer.
func (c *CustomNormalizer) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DocumentIntelligenceLayoutSkill.
func (d DocumentIntelligenceLayoutSkill) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "chunkingProperties", d.ChunkingProperties)
	populate(objectMap, "context", d.Context)
	populate(objectMap, "description", d.Description)
	populate(objectMap, "extractionOptions", d.ExtractionOptions)
	populate(objectMap, "inputs", d.Inputs)
	populate(objectMap, "markdownHeaderDepth", d.MarkdownHeaderDepth)
	populate(objectMap, "name", d.Name)
	objectMap["@odata.type"] = "#Microsoft.Skills.Util.DocumentIntelligenceLayoutSkill"
	populate(objectMap, "outputFormat", d.OutputFormat)
	populate(objectMap, "outputMode", d.OutputMode)
	populate(objectMap, "outputs", d.Outputs)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DocumentIntelligenceLayoutSkill.
func (d *DocumentIntelligenceLayoutSkill) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "chunkingProperties":
				err = unpopulate(val, "ChunkingProperties", &d.ChunkingProperties)
			delete(rawMsg, key)
		case "context":
				err = unpopulate(val, "Context", &d.Context)
			delete(rawMsg, key)
		case "description":
				err = unpopulate(val, "Description", &d.Description)
			delete(rawMsg, key)
		case "extractionOptions":
				err = unpopulate(val, "ExtractionOptions", &d.ExtractionOptions)
			delete(rawMsg, key)
		case "inputs":
				err = unpopulate(val, "Inputs", &d.Inputs)
			delete(rawMsg, key)
		case "markdownHeaderDepth":
				err = unpopulate(val, "MarkdownHeaderDepth", &d.MarkdownHeaderDepth)
			delete(rawMsg, key)
		case "name":
				err = unpopulate(val, "Name", &d.Name)
			delete(rawMsg, key)
		case "@odata.type":
			...
			delete(rawMsg, key)
		case "outputFormat":
				err = unpopulate(val, "OutputFormat", &d.OutputFormat)
			delete(rawMsg, key)
		case "outputMode":
				err = unpopulate(val, "OutputMode", &d.OutputMode)
			delete(rawMsg, key)
		case "outputs":
				err = unpopulate(val, "Outputs", &d.Outputs)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type DocumentIntelligenceLayoutSkillChunkingProperties.
func (d DocumentIntelligenceLayoutSkillChunkingProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "maximumLength", d.MaximumLength)
	populate(objectMap, "overlapLength", d.OverlapLength)
	populate(objectMap, "unit", d.Unit)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DocumentIntelligenceLayoutSkillChunkingProperties.
func (d *DocumentIntelligenceLayoutSkillChunkingProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "maximumLength":
				err = unpopulate(val, "MaximumLength", &d.MaximumLength)
			delete(rawMsg, key)
		case "overlapLength":
				err = unpopulate(val, "OverlapLength", &d.OverlapLength)
			delete(rawMsg, key)
		case "unit":
...
// MarshalJSON implements the json.Marshaller interface for type LexicalNormalizer.
func (l LexicalNormalizer) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", l.Name)
	objectMap["@odata.type"] = l.ODataType
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type LexicalNormalizer.
func (l *LexicalNormalizer) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type RescoringOptions.
func (r RescoringOptions) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "defaultOversampling", r.DefaultOversampling)
	populate(objectMap, "enableRescoring", r.EnableRescoring)
	populate(objectMap, "rescoreStorageMethod", r.RescoreStorageMethod)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type RescoringOptions.
func (r *RescoringOptions) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		case "defaultOversampling":
				err = unpopulate(val, "DefaultOversampling", &r.DefaultOversampling)
			delete(rawMsg, key)
		case "enableRescoring":
				err = unpopulate(val, "EnableRescoring", &r.EnableRescoring)
			delete(rawMsg, key)
		case "rescoreStorageMethod":
				err = unpopulate(val, "RescoreStorageMethod", &r.RescoreStorageMethod)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
func (s ScalarQuantizationCompressionConfiguration) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "rescoringOptions", s.RescoringOptions)
	populate(objectMap, "truncationDimension", s.TruncationDimension)
	return json.Marshal(objectMap)
}
...
func (s *ScalarQuantizationCompressionConfiguration) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "scalarQuantizationParameters":
			...
			delete(rawMsg, key)
		case "rescoringOptions":
				err = unpopulate(val, "RescoringOptions", &s.RescoringOptions)
			delete(rawMsg, key)
		case "truncationDimension":
				err = unpopulate(val, "TruncationDimension", &s.TruncationDimension)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SearchField.
func (s SearchField) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "analyzer", s.Analyzer)
	populate(objectMap, "facetable", s.Facetable)
	populate(objectMap, "fields", s.Fields)
	populate(objectMap, "filterable", s.Filterable)
	populate(objectMap, "indexAnalyzer", s.IndexAnalyzer)
	populate(objectMap, "key", s.Key)
	populate(objectMap, "name", s.Name)
	populate(objectMap, "normalizer", s.Normalizer)
	populate(objectMap, "retrievable", s.Retrievable)
	populate(objectMap, "searchAnalyzer", s.SearchAnalyzer)
	populate(objectMap, "searchable", s.Searchable)
	populate(objectMap, "sortable", s.Sortable)
	populate(objectMap, "stored", s.Stored)
	populate(objectMap, "synonymMaps", s.SynonymMaps)
	populate(objectMap, "type", s.Type)
	populate(objectMap, "vectorEncoding", s.VectorEncodingFormat)
	populate(objectMap, "dimensions", s.VectorSearchDimensions)
	populate(objectMap, "vectorSearchProfile", s.VectorSearchProfileName)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SearchField.
func (s *SearchField) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "analyzer":
				err = unpopulate(val, "Analyzer", &s.Analyzer)
			delete(rawMsg, key)
		case "facetable":
				err = unpopulate(val, "Facetable", &s.Facetable)
			delete(rawMsg, key)
		case "fields":
				err = unpopulate(val, "Fields", &s.Fields)
			delete(rawMsg, key)
		case "filterable":
				err = unpopulate(val, "Filterable", &s.Filterable)
			delete(rawMsg, key)
		case "indexAnalyzer":
				err = unpopulate(val, "IndexAnalyzer", &s.IndexAnalyzer)
			delete(rawMsg, key)
		case "key":
		...
		case "name":
			...
			delete(rawMsg, key)
		case "normalizer":
				err = unpopulate(val, "Normalizer", &s.Normalizer)
			delete(rawMsg, key)
		case "retrievable":
				err = unpopulate(val, "Retrievable", &s.Retrievable)
			delete(rawMsg, key)
		case "searchAnalyzer":
				err = unpopulate(val, "SearchAnalyzer", &s.SearchAnalyzer)
			delete(rawMsg, key)
		case "searchable":
				err = unpopulate(val, "Searchable", &s.Searchable)
			delete(rawMsg, key)
		case "sortable":
				err = unpopulate(val, "Sortable", &s.Sortable)
			delete(rawMsg, key)
		case "stored":
				err = unpopulate(val, "Stored", &s.Stored)
			delete(rawMsg, key)
		case "synonymMaps":
				err = unpopulate(val, "SynonymMaps", &s.SynonymMaps)
			delete(rawMsg, key)
		case "type":
				err = unpopulate(val, "Type", &s.Type)
			delete(rawMsg, key)
		case "vectorEncoding":
				err = unpopulate(val, "VectorEncodingFormat", &s.VectorEncodingFormat)
			delete(rawMsg, key)
		case "dimensions":
				err = unpopulate(val, "VectorSearchDimensions", &s.VectorSearchDimensions)
			delete(rawMsg, key)
		case "vectorSearchProfile":
				err = unpopulate(val, "VectorSearchProfileName", &s.VectorSearchProfileName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndex.
func (s SearchIndex) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "analyzers", s.Analyzers)
	populate(objectMap, "charFilters", s.CharFilters)
	populate(objectMap, "corsOptions", s.CorsOptions)
	populate(objectMap, "defaultScoringProfile", s.DefaultScoringProfile)
	populate(objectMap, "description", s.Description)
	populate(objectMap, "@odata.etag", s.ETag)
	populate(objectMap, "encryptionKey", s.EncryptionKey)
	populate(objectMap, "fields", s.Fields)
	populate(objectMap, "name", s.Name)
	populate(objectMap, "normalizers", s.Normalizers)
	populate(objectMap, "scoringProfiles", s.ScoringProfiles)
	populate(objectMap, "semantic", s.SemanticSearch)
	populate(objectMap, "similarity", s.Similarity)
	populate(objectMap, "suggesters", s.Suggesters)
	populate(objectMap, "tokenFilters", s.TokenFilters)
	populate(objectMap, "tokenizers", s.Tokenizers)
	populate(objectMap, "vectorSearch", s.VectorSearch)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndex.
func (s *SearchIndex) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "analyzers":
			s.Analyzers, err = unmarshalLexicalAnalyzerClassificationArray(val)
			delete(rawMsg, key)
		case "charFilters":
			s.CharFilters, err = unmarshalCharFilterClassificationArray(val)
			delete(rawMsg, key)
		case "corsOptions":
				err = unpopulate(val, "CorsOptions", &s.CorsOptions)
			delete(rawMsg, key)
		case "defaultScoringProfile":
				err = unpopulate(val, "DefaultScoringProfile", &s.DefaultScoringProfile)
			delete(rawMsg, key)
		case "description":
		...
		case "name":
			...
			delete(rawMsg, key)
		case "normalizers":
			s.Normalizers, err = unmarshalLexicalNormalizerClassificationArray(val)
			delete(rawMsg, key)
		case "scoringProfiles":
				err = unpopulate(val, "ScoringProfiles", &s.ScoringProfiles)
			delete(rawMsg, key)
		case "semantic":
				err = unpopulate(val, "SemanticSearch", &s.SemanticSearch)
			delete(rawMsg, key)
		case "similarity":
			s.Similarity, err = unmarshalSimilarityClassification(val)
			delete(rawMsg, key)
		case "suggesters":
				err = unpopulate(val, "Suggesters", &s.Suggesters)
			delete(rawMsg, key)
		case "tokenFilters":
			s.TokenFilters, err = unmarshalTokenFilterClassificationArray(val)
			delete(rawMsg, key)
		case "tokenizers":
			s.Tokenizers, err = unmarshalLexicalTokenizerClassificationArray(val)
			delete(rawMsg, key)
		case "vectorSearch":
				err = unpopulate(val, "VectorSearch", &s.VectorSearch)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexer.
func (s SearchIndexer) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "dataSourceName", s.DataSourceName)
	populate(objectMap, "description", s.Description)
	populate(objectMap, "@odata.etag", s.ETag)
	populate(objectMap, "encryptionKey", s.EncryptionKey)
	populate(objectMap, "fieldMappings", s.FieldMappings)
	populate(objectMap, "disabled", s.IsDisabled)
	populate(objectMap, "name", s.Name)
	populate(objectMap, "outputFieldMappings", s.OutputFieldMappings)
	populate(objectMap, "parameters", s.Parameters)
	populate(objectMap, "schedule", s.Schedule)
	populate(objectMap, "skillsetName", s.SkillsetName)
	populate(objectMap, "targetIndexName", s.TargetIndexName)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexer.
func (s *SearchIndexer) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "dataSourceName":
				err = unpopulate(val, "DataSourceName", &s.DataSourceName)
			delete(rawMsg, key)
		case "description":
				err = unpopulate(val, "Description", &s.Description)
			delete(rawMsg, key)
		...
		case "encryptionKey":
			...
			delete(rawMsg, key)
		case "fieldMappings":
				err = unpopulate(val, "FieldMappings", &s.FieldMappings)
			delete(rawMsg, key)
		case "disabled":
		...
		case "outputFieldMappings":
				err = unpopulate(val, "OutputFieldMappings", &s.OutputFieldMappings)
			delete(rawMsg, key)
		case "parameters":
				err = unpopulate(val, "Parameters", &s.Parameters)
			delete(rawMsg, key)
		case "schedule":
			...
			delete(rawMsg, key)
		case "skillsetName":
				err = unpopulate(val, "SkillsetName", &s.SkillsetName)
			delete(rawMsg, key)
		case "targetIndexName":
				err = unpopulate(val, "TargetIndexName", &s.TargetIndexName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerDataContainer.
func (s SearchIndexerDataContainer) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", s.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerDataContainer.
func (s *SearchIndexerDataContainer) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerDataIdentity.
func (s SearchIndexerDataIdentity) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["@odata.type"] = s.ODataType
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerDataIdentity.
func (s *SearchIndexerDataIdentity) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerDataNoneIdentity.
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerDataNoneIdentity.
func (s *SearchIndexerDataNoneIdentity) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerDataSource.
func (s SearchIndexerDataSource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "container", s.Container)
	populate(objectMap, "credentials", s.Credentials)
	populate(objectMap, "dataChangeDetectionPolicy", s.DataChangeDetectionPolicy)
	populate(objectMap, "dataDeletionDetectionPolicy", s.DataDeletionDetectionPolicy)
	populate(objectMap, "description", s.Description)
	populate(objectMap, "@odata.etag", s.ETag)
	populate(objectMap, "encryptionKey", s.EncryptionKey)
	populate(objectMap, "name", s.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerDataSource.
func (s *SearchIndexerDataSource) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "dataChangeDetectionPolicy":
			s.DataChangeDetectionPolicy, err = unmarshalDataChangeDetectionPolicyClassification(val)
			delete(rawMsg, key)
		case "dataDeletionDetectionPolicy":
			s.DataDeletionDetectionPolicy, err = unmarshalDataDeletionDetectionPolicyClassification(val)
			delete(rawMsg, key)
		case "description":
				err = unpopulate(val, "Description", &s.Description)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerDataUserAssignedIdentity.
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerDataUserAssignedIdentity.
func (s *SearchIndexerDataUserAssignedIdentity) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerError.
func (s SearchIndexerError) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerError.
func (s *SearchIndexerError) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerIndexProjectionSelector.
func (s SearchIndexerIndexProjectionSelector) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "mappings", s.Mappings)
	populate(objectMap, "parentKeyFieldName", s.ParentKeyFieldName)
	populate(objectMap, "sourceContext", s.SourceContext)
	populate(objectMap, "targetIndexName", s.TargetIndexName)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerIndexProjectionSelector.
func (s *SearchIndexerIndexProjectionSelector) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "mappings":
				err = unpopulate(val, "Mappings", &s.Mappings)
			delete(rawMsg, key)
		case "parentKeyFieldName":
				err = unpopulate(val, "ParentKeyFieldName", &s.ParentKeyFieldName)
			delete(rawMsg, key)
		case "sourceContext":
				err = unpopulate(val, "SourceContext", &s.SourceContext)
			delete(rawMsg, key)
		case "targetIndexName":
				err = unpopulate(val, "TargetIndexName", &s.TargetIndexName)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerIndexProjections.
func (s SearchIndexerIndexProjections) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "parameters", s.Parameters)
	populate(objectMap, "selectors", s.Selectors)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerIndexProjections.
func (s *SearchIndexerIndexProjections) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "parameters":
			...
			delete(rawMsg, key)
		case "selectors":
				err = unpopulate(val, "Selectors", &s.Selectors)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerIndexProjectionsParameters.
func (s SearchIndexerIndexProjectionsParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "projectionMode", s.ProjectionMode)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerIndexProjectionsParameters.
func (s *SearchIndexerIndexProjectionsParameters) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "projectionMode":
				err = unpopulate(val, "ProjectionMode", &s.ProjectionMode)
			delete(rawMsg, key)
		default:
			if s.AdditionalProperties == nil {
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerKnowledgeStore.
func (s SearchIndexerKnowledgeStore) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "projections", s.Projections)
	populate(objectMap, "storageConnectionString", s.StorageConnectionString)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerKnowledgeStore.
func (s *SearchIndexerKnowledgeStore) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "projections":
				err = unpopulate(val, "Projections", &s.Projections)
			delete(rawMsg, key)
		case "storageConnectionString":
				err = unpopulate(val, "StorageConnectionString", &s.StorageConnectionString)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerKnowledgeStoreBlobProjectionSelector.
func (s SearchIndexerKnowledgeStoreBlobProjectionSelector) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "generatedKeyName", s.GeneratedKeyName)
	populate(objectMap, "inputs", s.Inputs)
	populate(objectMap, "referenceKeyName", s.ReferenceKeyName)
	populate(objectMap, "source", s.Source)
	populate(objectMap, "sourceContext", s.SourceContext)
	populate(objectMap, "storageContainer", s.StorageContainer)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerKnowledgeStoreBlobProjectionSelector.
func (s *SearchIndexerKnowledgeStoreBlobProjectionSelector) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "generatedKeyName":
				err = unpopulate(val, "GeneratedKeyName", &s.GeneratedKeyName)
			delete(rawMsg, key)
		case "inputs":
				err = unpopulate(val, "Inputs", &s.Inputs)
			delete(rawMsg, key)
		case "referenceKeyName":
				err = unpopulate(val, "ReferenceKeyName", &s.ReferenceKeyName)
			delete(rawMsg, key)
		case "source":
		...
		case "storageContainer":
				err = unpopulate(val, "StorageContainer", &s.StorageContainer)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerKnowledgeStoreFileProjectionSelector.
func (s SearchIndexerKnowledgeStoreFileProjectionSelector) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "generatedKeyName", s.GeneratedKeyName)
	populate(objectMap, "inputs", s.Inputs)
	populate(objectMap, "referenceKeyName", s.ReferenceKeyName)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerKnowledgeStoreFileProjectionSelector.
func (s *SearchIndexerKnowledgeStoreFileProjectionSelector) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerKnowledgeStoreObjectProjectionSelector.
func (s SearchIndexerKnowledgeStoreObjectProjectionSelector) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "generatedKeyName", s.GeneratedKeyName)
	populate(objectMap, "inputs", s.Inputs)
	populate(objectMap, "referenceKeyName", s.ReferenceKeyName)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerKnowledgeStoreObjectProjectionSelector.
func (s *SearchIndexerKnowledgeStoreObjectProjectionSelector) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerKnowledgeStoreParameters.
func (s SearchIndexerKnowledgeStoreParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "synthesizeGeneratedKeyName", s.SynthesizeGeneratedKeyName)
	if s.AdditionalProperties != nil {
		for key, val := range s.AdditionalProperties {
			objectMap[key] = val
		}
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerKnowledgeStoreParameters.
func (s *SearchIndexerKnowledgeStoreParameters) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "synthesizeGeneratedKeyName":
				err = unpopulate(val, "SynthesizeGeneratedKeyName", &s.SynthesizeGeneratedKeyName)
			delete(rawMsg, key)
		default:
			if s.AdditionalProperties == nil {
				s.AdditionalProperties = map[string]any{}
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerKnowledgeStoreProjection.
func (s SearchIndexerKnowledgeStoreProjection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "files", s.Files)
	populate(objectMap, "objects", s.Objects)
	populate(objectMap, "tables", s.Tables)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerKnowledgeStoreProjection.
func (s *SearchIndexerKnowledgeStoreProjection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "files":
			...
			delete(rawMsg, key)
		case "objects":
				err = unpopulate(val, "Objects", &s.Objects)
			delete(rawMsg, key)
		case "tables":
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerKnowledgeStoreProjectionSelector.
func (s SearchIndexerKnowledgeStoreProjectionSelector) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "generatedKeyName", s.GeneratedKeyName)
	populate(objectMap, "inputs", s.Inputs)
	populate(objectMap, "referenceKeyName", s.ReferenceKeyName)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerKnowledgeStoreProjectionSelector.
func (s *SearchIndexerKnowledgeStoreProjectionSelector) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerKnowledgeStoreTableProjectionSelector.
func (s SearchIndexerKnowledgeStoreTableProjectionSelector) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "generatedKeyName", s.GeneratedKeyName)
	populate(objectMap, "inputs", s.Inputs)
	populate(objectMap, "referenceKeyName", s.ReferenceKeyName)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerKnowledgeStoreTableProjectionSelector.
func (s *SearchIndexerKnowledgeStoreTableProjectionSelector) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerLimits.
func (s SearchIndexerLimits) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "maxDocumentContentCharactersToExtract", s.MaxDocumentContentCharactersToExtract)
	populate(objectMap, "maxDocumentExtractionSize", s.MaxDocumentExtractionSize)
	populate(objectMap, "maxRunTime", s.MaxRunTime)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerLimits.
func (s *SearchIndexerLimits) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "maxDocumentContentCharactersToExtract":
				err = unpopulate(val, "MaxDocumentContentCharactersToExtract", &s.MaxDocumentContentCharactersToExtract)
			delete(rawMsg, key)
		case "maxDocumentExtractionSize":
				err = unpopulate(val, "MaxDocumentExtractionSize", &s.MaxDocumentExtractionSize)
			delete(rawMsg, key)
		case "maxRunTime":
				err = unpopulate(val, "MaxRunTime", &s.MaxRunTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerSkill.
func (s SearchIndexerSkill) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerSkill.
func (s *SearchIndexerSkill) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerSkillset.
func (s SearchIndexerSkillset) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "cognitiveServices", s.CognitiveServicesAccount)
	populate(objectMap, "description", s.Description)
	populate(objectMap, "@odata.etag", s.ETag)
	populate(objectMap, "encryptionKey", s.EncryptionKey)
	populate(objectMap, "indexProjections", s.IndexProjections)
	populate(objectMap, "knowledgeStore", s.KnowledgeStore)
	populate(objectMap, "name", s.Name)
	populate(objectMap, "skills", s.Skills)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerSkillset.
func (s *SearchIndexerSkillset) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "cognitiveServices":
			s.CognitiveServicesAccount, err = unmarshalCognitiveServicesAccountClassification(val)
			delete(rawMsg, key)
		case "description":
				err = unpopulate(val, "Description", &s.Description)
			delete(rawMsg, key)
		...
		case "indexProjections":
				err = unpopulate(val, "IndexProjections", &s.IndexProjections)
			delete(rawMsg, key)
		case "knowledgeStore":
				err = unpopulate(val, "KnowledgeStore", &s.KnowledgeStore)
			delete(rawMsg, key)
		case "name":
				err = unpopulate(val, "Name", &s.Name)
			delete(rawMsg, key)
		case "skills":
			s.Skills, err = unmarshalSearchIndexerSkillClassificationArray(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerStatus.
func (s SearchIndexerStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "executionHistory", s.ExecutionHistory)
	populate(objectMap, "lastResult", s.LastResult)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerStatus.
func (s *SearchIndexerStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "executionHistory":
				err = unpopulate(val, "ExecutionHistory", &s.ExecutionHistory)
			delete(rawMsg, key)
		case "lastResult":
				err = unpopulate(val, "LastResult", &s.LastResult)
			delete(rawMsg, key)
		case "limits":
...
// MarshalJSON implements the json.Marshaller interface for type SearchIndexerWarning.
func (s SearchIndexerWarning) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "details", s.Details)
	populate(objectMap, "documentationLink", s.DocumentationLink)
	populate(objectMap, "key", s.Key)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SearchIndexerWarning.
func (s *SearchIndexerWarning) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SearchResourceEncryptionKey.
func (s SearchResourceEncryptionKey) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "accessCredentials", s.AccessCredentials)
	populate(objectMap, "keyVaultKeyName", s.KeyName)
	populate(objectMap, "keyVaultKeyVersion", s.KeyVersion)
	populate(objectMap, "keyVaultUri", s.VaultURI)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SearchResourceEncryptionKey.
func (s *SearchResourceEncryptionKey) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "accessCredentials":
				err = unpopulate(val, "AccessCredentials", &s.AccessCredentials)
			delete(rawMsg, key)
...
func (s SemanticConfiguration) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "rankingOrder", s.RankingOrder)
	return json.Marshal(objectMap)
}
...
func (s *SemanticConfiguration) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "prioritizedFields":
			...
			delete(rawMsg, key)
		case "rankingOrder":
				err = unpopulate(val, "RankingOrder", &s.RankingOrder)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
func (v VectorSearchCompressionConfiguration) MarshalJSON() ([]byte, error) {
	...
	objectMap["kind"] = v.Kind
	populate(objectMap, "name", v.Name)
	populate(objectMap, "rescoringOptions", v.RescoringOptions)
	populate(objectMap, "truncationDimension", v.TruncationDimension)
	return json.Marshal(objectMap)
}
...
func (v *VectorSearchCompressionConfiguration) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "name":
			...
			delete(rawMsg, key)
		case "rescoringOptions":
				err = unpopulate(val, "RescoringOptions", &v.RescoringOptions)
			delete(rawMsg, key)
		case "truncationDimension":
				err = unpopulate(val, "TruncationDimension", &v.TruncationDimension)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", v, err)
...
func (w *WebAPIParameters) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "authIdentity":
			w.AuthIdentity, err = unmarshalSearchIndexerDataIdentityClassification(val)
			delete(rawMsg, key)
		case "authResourceId":
