...
func (client *DataSourcesClient) Create(ctx context.Context, dataSource SearchIndexerDataSource, requestOptions *RequestOptions, options *DataSourcesClientCreateOptions) (DataSourcesClientCreateResponse, error) {
	var err error
...
func (client *DataSourcesClient) createCreateRequest(ctx context.Context, dataSource SearchIndexerDataSource, requestOptions *RequestOptions, _ *DataSourcesClientCreateOptions) (*policy.Request, error) {
	urlPath := "/datasources"
...
func (client *DataSourcesClient) createHandleResponse(resp *http.Response) (DataSourcesClientCreateResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SearchIndexerDataSource); err != nil {
		return DataSourcesClientCreateResponse{}, err
	}
	return result, nil
}
...
//     method.
func (client *DataSourcesClient) CreateOrUpdate(ctx context.Context, dataSourceName string, prefer Enum0, dataSource SearchIndexerDataSource, requestOptions *RequestOptions, options *DataSourcesClientCreateOrUpdateOptions) (DataSourcesClientCreateOrUpdateResponse, error) {
	var err error
...
func (client *DataSourcesClient) createOrUpdateCreateRequest(ctx context.Context, dataSourceName string, prefer Enum0, dataSource SearchIndexerDataSource, requestOptions *RequestOptions, options *DataSourcesClientCreateOrUpdateOptions) (*policy.Request, error) {
