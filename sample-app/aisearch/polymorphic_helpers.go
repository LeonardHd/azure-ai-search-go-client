...
func unmarshalLexicalNormalizerClassification(rawMsg json.RawMessage) (LexicalNormalizerClassification, error) {
	if rawMsg == nil || string(rawMsg) == "null" {
		return nil, nil
	}
	var m map[string]any
	...
	var b LexicalNormalizerClassification
	switch m["@odata.type"] {
...
func unmarshalLexicalNormalizerClassificationArray(rawMsg json.RawMessage) ([]LexicalNormalizerClassification, error) {
	if rawMsg == nil || string(rawMsg) == "null" {
		return nil, nil
	}
	var rawMessages []json.RawMessage
	...
	fArray := make([]LexicalNormalizerClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalLexicalNormalizerClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
...
func unmarshalSearchIndexerDataIdentityClassification(rawMsg json.RawMessage) (SearchIndexerDataIdentityClassification, error) {
	if rawMsg == nil || string(rawMsg) == "null" {
		return nil, nil
	}
	var m map[string]any
	...
	var b SearchIndexerDataIdentityClassification
	switch m["@odata.type"] {
	case "#Microsoft.Azure.Search.DataNoneIdentity":
		b = &SearchIndexerDataNoneIdentity{}
	case "#Microsoft.Azure.Search.DataUserAssignedIdentity":
		b = &SearchIndexerDataUserAssignedIdentity{}
	default:
		b = &SearchIndexerDataIdentity{}
	}
	if err := json.Unmarshal(rawMsg, b); err != nil {
		return nil, err
	}
...
func unmarshalSearchIndexerSkillClassification(rawMsg json.RawMessage) (SearchIndexerSkillClassification, error) {
	if rawMsg == nil || string(rawMsg) == "null" {
		return nil, nil
	}
	var m map[string]any
	...
	var b SearchIndexerSkillClassification
	switch m["@odata.type"] {
	...
	case "#Microsoft.Skills.Util.DocumentIntelligenceLayoutSkill":
		b = &DocumentIntelligenceLayoutSkill{}
...
func unmarshalSearchIndexerSkillClassificationArray(rawMsg json.RawMessage) ([]SearchIndexerSkillClassification, error) {
	if rawMsg == nil || string(rawMsg) == "null" {
		return nil, nil
	}
	var rawMessages []json.RawMessage
	...
	fArray := make([]SearchIndexerSkillClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalSearchIndexerSkillClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
