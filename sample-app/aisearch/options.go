...
// SearchServiceClientGetServiceStatisticsOptions contains the optional parameters for the SearchServiceClient.GetServiceStatistics
// method.
type SearchServiceClientGetServiceStatisticsOptions struct {
	// placeholder for future optional parameters
}
