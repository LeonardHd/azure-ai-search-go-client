...
// MarshalJSON implements the json.Marshaller interface for type DocumentDebugInfo.
func (d DocumentDebugInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "vectors", d.Vectors)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DocumentDebugInfo.
func (d *DocumentDebugInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "vectors":
				err = unpopulate(val, "Vectors", &d.Vectors)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
// MarshalJSON implements the json.Marshaller interface for type QueryResultDocumentSubscores.
func (q QueryResultDocumentSubscores) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "documentBoost", q.DocumentBoost)
	populate(objectMap, "text", q.Text)
	populate(objectMap, "vectors", q.Vectors)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type QueryResultDocumentSubscores.
func (q *QueryResultDocumentSubscores) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", q, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "documentBoost":
				err = unpopulate(val, "DocumentBoost", &q.DocumentBoost)
			delete(rawMsg, key)
		case "text":
				err = unpopulate(val, "Text", &q.Text)
			delete(rawMsg, key)
		case "vectors":
				err = unpopulate(val, "Vectors", &q.Vectors)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", q, err)
...
func (s SearchRequest) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "debug", s.Debug)
...
func (s *SearchRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "captions":
			...
			delete(rawMsg, key)
		case "debug":
				err = unpopulate(val, "Debug", &s.Debug)
			delete(rawMsg, key)
		case "facets":
				err = unpopulate(val, "Facets", &s.Facets)
			delete(rawMsg, key)
...
func (s SearchResult) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "@search.documentDebugInfo", s.DocumentDebugInfo)
	populate(objectMap, "@search.highlights", s.Highlights)
	populate(objectMap, "@search.rerankerBoostedScore", s.RerankerBoostedScore)
...
func (s *SearchResult) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "@search.captions":
				err = unpopulate(val, "Captions", &s.Captions)
			delete(rawMsg, key)
		case "@search.documentDebugInfo":
				err = unpopulate(val, "DocumentDebugInfo", &s.DocumentDebugInfo)
			delete(rawMsg, key)
		case "@search.highlights":
				err = unpopulate(val, "Highlights", &s.Highlights)
			delete(rawMsg, key)
		case "@search.rerankerBoostedScore":
				err = unpopulate(val, "RerankerBoostedScore", &s.RerankerBoostedScore)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type SingleVectorFieldResult.
func (s SingleVectorFieldResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "searchScore", s.SearchScore)
	populate(objectMap, "vectorSimilarity", s.VectorSimilarity)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SingleVectorFieldResult.
func (s *SingleVectorFieldResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "searchScore":
				err = unpopulate(val, "SearchScore", &s.SearchScore)
			delete(rawMsg, key)
		case "vectorSimilarity":
				err = unpopulate(val, "VectorSimilarity", &s.VectorSimilarity)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type TextResult.
func (t TextResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "searchScore", t.SearchScore)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type TextResult.
func (t *TextResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "searchScore":
				err = unpopulate(val, "SearchScore", &t.SearchScore)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", t, err)
...
// MarshalJSON implements the json.Marshaller interface for type VectorsDebugInfo.
func (v VectorsDebugInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "subscores", v.Subscores)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type VectorsDebugInfo.
func (v *VectorsDebugInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", v, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "subscores":
				err = unpopulate(val, "Subscores", &v.Subscores)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", v, err)
