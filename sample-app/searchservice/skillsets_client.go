...
func (client *SkillsetsClient) Create(ctx context.Context, skillset SearchIndexerSkillset, requestOptions *RequestOptions, options *SkillsetsClientCreateOptions) (SkillsetsClientCreateResponse, error) {
	var err error
...
func (client *SkillsetsClient) createCreateRequest(ctx context.Context, skillset SearchIndexerSkillset, requestOptions *RequestOptions, _ *SkillsetsClientCreateOptions) (*policy.Request, error) {
	urlPath := "/skillsets"
...
func (client *SkillsetsClient) createHandleResponse(resp *http.Response) (SkillsetsClientCreateResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SearchIndexerSkillset); err != nil {
		return SkillsetsClientCreateResponse{}, err
	}
	return result, nil
}
...
//     method.
func (client *SkillsetsClient) CreateOrUpdate(ctx context.Context, skillsetName string, prefer Enum0, skillset SearchIndexerSkillset, requestOptions *RequestOptions, options *SkillsetsClientCreateOrUpdateOptions) (SkillsetsClientCreateOrUpdateResponse, error) {
	var err error
...
func (client *SkillsetsClient) createOrUpdateCreateRequest(ctx context.Context, skillsetName string, prefer Enum0, skillset SearchIndexerSkillset, requestOptions *RequestOptions, options *SkillsetsClientCreateOrUpdateOptions) (*policy.Request, error) {
