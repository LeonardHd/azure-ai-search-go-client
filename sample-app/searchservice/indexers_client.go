...
func (client *IndexersClient) Create(ctx context.Context, indexer SearchIndexer, requestOptions *RequestOptions, options *IndexersClientCreateOptions) (IndexersClientCreateResponse, error) {
	var err error
...
func (client *IndexersClient) createCreateRequest(ctx context.Context, indexer SearchIndexer, requestOptions *RequestOptions, _ *IndexersClientCreateOptions) (*policy.Request, error) {
	urlPath := "/indexers"
...
func (client *IndexersClient) createHandleResponse(resp *http.Response) (IndexersClientCreateResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SearchIndexer); err != nil {
		return IndexersClientCreateResponse{}, err
	}
	return result, nil
}
...
func (client *IndexersClient) CreateOrUpdate(ctx context.Context, indexerName string, prefer Enum0, indexer SearchIndexer, requestOptions *RequestOptions, options *IndexersClientCreateOrUpdateOptions) (IndexersClientCreateOrUpdateResponse, error) {
	var err error
...
func (client *IndexersClient) createOrUpdateCreateRequest(ctx context.Context, indexerName string, prefer Enum0, indexer SearchIndexer, requestOptions *RequestOptions, options *IndexersClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *IndexersClient) getStatusHandleResponse(resp *http.Response) (IndexersClientGetStatusResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SearchIndexerStatus); err != nil {
		return IndexersClientGetStatusResponse{}, err
	}
	return result, nil
}
