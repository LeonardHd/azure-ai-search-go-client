...
// The user-assigned managed identity used for outbound connections.
	AuthIdentity SearchIndexerDataIdentityClassification
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type AzureOpenAIEmbeddingSkill.
func (a *AzureOpenAIEmbeddingSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
...
// The number of dimensions to truncate the vectors to. Truncating the vectors reduces the size of the vectors and the amount
// of data that needs to be transferred during search. This can save storage
// cost and improve search performance at the expense of recall. It should be only used for embeddings trained with Matryoshka
// Representation Learning (MRL) such as OpenAI text-embedding-3-large (small).
// The default value is null, which means no truncation.
...
func (b *BinaryQuantizationCompressionConfiguration) GetVectorSearchCompressionConfiguration() *VectorSearchCompressionConfiguration {
	return &VectorSearchCompressionConfiguration{
		Kind: b.Kind,
		Name: b.Name,
		RescoringOptions: b.RescoringOptions,
		TruncationDimension: b.TruncationDimension,
	}
}
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type ConditionalSkill.
func (c *ConditionalSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: c.Context,
		Description: c.Description,
		Inputs: c.Inputs,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type CustomEntityLookupSkill.
func (c *CustomEntityLookupSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: c.Context,
		Description: c.Description,
		Inputs: c.Inputs,
...
// CustomNormalizer - Allows you to configure normalization for filterable, sortable, and facetable fields, which by default
// operate with strict matching. This is a user-defined configuration consisting of at least one or
// more filters, which modify the token that is stored.
type CustomNormalizer struct {
// REQUIRED; The name of the normalizer. It must only contain letters, digits, spaces, dashes or underscores, can only start
// and end with alphanumeric characters, and is limited to 128 characters. It cannot end in
// '.microsoft' nor '.lucene', nor be named 'asciifolding', 'standard', 'lowercase', 'uppercase', or 'elision'.
	Name *string

// REQUIRED; A URI fragment specifying the type of normalizer.
	ODataType *string

// A list of character filters used to prepare input text before it is processed. For instance, they can replace certain characters
// or symbols. The filters are run in the order in which they are listed.
	CharFilters []*CharFilterName

// A list of token filters used to filter out or modify the input token. For example, you can specify a lowercase filter that
// converts all characters to lowercase. The filters are run in the order in
// which they are listed.
	TokenFilters []*TokenFilterName
}

// GetLexicalNormalizer implements the LexicalNormalizerClassification interface for type CustomNormalizer.
func (c *CustomNormalizer) GetLexicalNormalizer() *LexicalNormalizer {
...
// The connection string for the datasource. For Azure SQL, Azure Blob, ADLS Gen 2 and Azure Table, this would be the connection
// string or resource ID if using managed identity. For CosmosDB this would
// be a formatted connection string specifying ApiKind or resource ID for managed identity. For Onelake files, connection
// string would be either the workspace guid or workspace FQDN; Onelake only
// supports managed identity connections. Set to <unchanged> (with brackets) if you don't want the connection string updated.
// Set to <redacted> if you want to remove the connection string value from the
// datasource.
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type DocumentExtractionSkill.
func (d *DocumentExtractionSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: d.Context,
		Description: d.Description,
		Inputs: d.Inputs,
...
// DocumentIntelligenceLayoutSkill - A skill that extracts content and layout information, via Azure AI Services, from files
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type DocumentIntelligenceLayoutSkill.
func (d *DocumentIntelligenceLayoutSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: d.Context,
		Description: d.Description,
		Inputs: d.Inputs,
...
// DocumentIntelligenceLayoutSkillChunkingProperties - Controls the cardinality for chunking the content.
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type EntityLinkingSkill.
func (e *EntityLinkingSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: e.Context,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type EntityRecognitionSkill.
func (e *EntityRecognitionSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: e.Context,
		Description: e.Description,
		Inputs: e.Inputs,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type EntityRecognitionSkillV3.
func (e *EntityRecognitionSkillV3) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: e.Context,
		Description: e.Description,
		Inputs: e.Inputs,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type ImageAnalysisSkill.
func (i *ImageAnalysisSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: i.Context,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type KeyPhraseExtractionSkill.
func (k *KeyPhraseExtractionSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: k.Context,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type LanguageDetectionSkill.
func (l *LanguageDetectionSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: l.Context,
...
// GetLexicalNormalizer implements the LexicalNormalizerClassification interface for type LexicalNormalizer.
func (l *LexicalNormalizer) GetLexicalNormalizer() *LexicalNormalizer { return l }
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type MergeSkill.
func (m *MergeSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: m.Context,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type OcrSkill.
func (o *OcrSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: o.Context,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type PIIDetectionSkill.
func (p *PIIDetectionSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: p.Context,
...
// RescoringOptions - Contains the options for rescoring.
...
// due to quantization. This increases the set of results that will be rescored on
// full-precision vectors. Minimum value is 1, meaning no oversampling (1x). This parameter can only be set when 'enableRescoring'
// is true. Higher values improve recall at the expense of latency.
	DefaultOversampling *float64

// If set to true, after the initial search on the compressed vectors, the similarity scores are recalculated using the full-precision
// vectors. This will improve recall at the expense of latency.
...
// SearchField - Represents a field in an index definition, which describes the name, data type, and search behavior of a
// field.
...
// The name of the normalizer to use for the field. This option can be used only with fields with filterable, sortable, or
// facetable enabled. Once the normalizer is chosen, it cannot be changed for the
...
// The normalizers for the index.
	Normalizers []LexicalNormalizerClassification
...
// SearchIndexerDataContainer - Represents information about the entity (such as Azure SQL table or CosmosDB collection) that
// will be indexed.
type SearchIndexerDataContainer struct {
// REQUIRED; The name of the table or view (for Azure SQL datasource), collection (for CosmosDB datasource), container (for
// Azure Blob and ADLS Gen 2 datasources), Azure Table (for Azure Table datasource), or
// lakehouse (for Onelake datasource) that will be indexed.
	Name *string

// A query that is applied to this data container. For CosmosDB datasource query can flatten and filter data. For Azure Blob
// and ADLS Gen 2 query can filter by folders. For Azure Table query can filter
// by row data. For Onelake query can filter by folder or shortcut. Not supported by Azure SQL datasources.
	Query *string
}
...
// GetSearchIndexerDataIdentity implements the SearchIndexerDataIdentityClassification interface for type SearchIndexerDataIdentity.
func (s *SearchIndexerDataIdentity) GetSearchIndexerDataIdentity() *SearchIndexerDataIdentity { return s }
...
// GetSearchIndexerDataIdentity implements the SearchIndexerDataIdentityClassification interface for type SearchIndexerDataNoneIdentity.
func (s *SearchIndexerDataNoneIdentity) GetSearchIndexerDataIdentity() *SearchIndexerDataIdentity {
...
// GetSearchIndexerDataIdentity implements the SearchIndexerDataIdentityClassification interface for type SearchIndexerDataUserAssignedIdentity.
func (s *SearchIndexerDataUserAssignedIdentity) GetSearchIndexerDataIdentity() *SearchIndexerDataIdentity {
	return &SearchIndexerDataIdentity{
		ODataType: s.ODataType,
	}
}
...
// SearchIndexerIndexProjectionSelector - Description for what data to store in the designated search index.
...
// SearchIndexerIndexProjections - Definition of additional projections to secondary search indexes.
...
// SearchIndexerIndexProjectionsParameters - A dictionary of index projection-specific configuration properties. Each name
// is the name of a specific property. Each value must be of a primitive type.
type SearchIndexerIndexProjectionsParameters struct {
// OPTIONAL; Contains additional key/value pairs not defined in the schema.
	AdditionalProperties map[string]any
...
// SearchIndexerKnowledgeStoreParameters - A dictionary of knowledge store-specific configuration properties. Each name is
// the name of a specific property. Each value must be of a primitive type.
type SearchIndexerKnowledgeStoreParameters struct {
// OPTIONAL; Contains additional key/value pairs not defined in the schema.
	AdditionalProperties map[string]any
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type SearchIndexerSkill.
func (s *SearchIndexerSkill) GetSearchIndexerSkill() *SearchIndexerSkill { return s }
...
// REQUIRED; A list of skills in the skillset.
	Skills []SearchIndexerSkillClassification
...
// READ-ONLY; The name of the indexer.
	Name *string
...
// SearchResourceEncryptionKey - A customer-managed encryption key in Azure Key Vault. Keys that you create and manage can
// be used to encrypt or decrypt data-at-rest, such as indexes and synonym maps.
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type SentimentSkill.
func (s *SentimentSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: s.Context,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type SentimentSkillV3.
func (s *SentimentSkillV3) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: s.Context,
		Description: s.Description,
		Inputs: s.Inputs,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type ShaperSkill.
func (s *ShaperSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: s.Context,
		Description: s.Description,
		Inputs: s.Inputs,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type SplitSkill.
func (s *SplitSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: s.Context,
		Description: s.Description,
		Inputs: s.Inputs,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type TextTranslationSkill.
func (t *TextTranslationSkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: t.Context,
...
// GetSearchIndexerSkill implements the SearchIndexerSkillClassification interface for type WebAPISkill.
func (w *WebAPISkill) GetSearchIndexerSkill() *SearchIndexerSkill {
	return &SearchIndexerSkill{
		Context: w.Context,
